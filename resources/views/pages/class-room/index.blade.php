                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <a class="btn btn-icon icon-left btn-primary" href="{{ route('class-room.create') }}">Create New
                                    Classroom</a> 
                                ...
                                <table class="table table-bordered table-md">
                                    <tbody>
                                        ...
                                        @foreach ($classRooms as $key => $classRoom)
                                            <tr>
                                                <td>{{ ($classRoom->currentPage() - 1) * $classRoom->perPage() + $key + 1 }}</td>
                                                <td>{{ $classRoom->name_claass }}</td>
                                                
                                                <td class="text-right">
                                                    <div class="d-flex justify-content-end">
                                                        <a href="{{ route('user.edit', $classRoom->id) }}"
                                                            class="btn btn-sm btn-info btn-icon "><i
                                                                class="fas fa-edit"></i>
                                                            Edit</a>
                                                        <form action="{{ route('user.destroy', $classRoom->id) }}"
